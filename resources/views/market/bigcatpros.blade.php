...
<div class="row">
  <div class="col-xs-12 col-md-6 col-sm-6 min-padding">
      <ul class="breadcrumb"><li class="active">{{ $bigcat->name }}</li>
</ul>    </div>
</div>
<div class="row">
  <div class="col-md-12">
...
<div class="row">
  <div class="col-md-12">
      <div class="row" id="mp-product-block">
        ...
        <?php
            $products = App\Product::where('sub_product_category_id',$sub->id)->paginate(9);
         ?>
         @foreach($products as $pro)
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 min-padding">
                  <div class="mp-product-block">
                         <a href="{{ route('info',['product_id' => $pro->id]) }}">
                          <img class="product-image" src="{{ $pro->image?asset('img/products/'.$pro->image):asset('img/defaults/'.$bigcat->image) }}">
                      </a>
                      <div class="row">
                          <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            ...
                            @if(Auth::user()->role == 'customer')
                              <div class="product-button">
                                  <a href="{{ route('info',['product_id' => $pro->id]) }}" class="btn btn-100 btn-success add-to-cart" data-product-id="1475098"><isc class="pe-7s-cart" aria-hidden="true"></isc> КУПИТЬ</a>
                              </div>
                            @else
